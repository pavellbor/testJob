...
window.onload = function () {
  if (sessionStorage.getItem("showPreloader") == 0) {
    ...
    setTimeout(function () {
      writeTextByJS(".preloader__title", ["Арена"], 100);
    }, 0);
    setTimeout(function () {
      writeTextByJS(".preloader__subtitle", ["Группа компаний"], 100);
    }, 1000);
    setTimeout(function () {
      document.querySelector(".preloader").classList.add("preloader-remove");
    }, 3000);
    ...
    sessionStorage.setItem("showPreloader", "0");
  }
};

function writeTextByJS(selector, text, speed) {
